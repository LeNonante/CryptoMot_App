        ...
        if nblettrea!=0 and nblettreb!=0 : #Test variable(s) vide(s) pour message erreur
                for k in a :
                    ...
                    if x==32 : #Si c'est un espace, on lui donne 64 comme valeur
                        ...
                        x=x-96
##                    elif x==10 : #Si c'est un retour à la ligne on lui donne 65
##                        x=65
                    ...
                    if zf>0 and zf<27 : #Si c'est une minuscule, on lui donne une valeur de 97 à 122
                        ...
                        zf=32
##                    elif zf==65 : #Si c'est un retour a la ligne, on lui donne 10 comme valeur
##                        zf=10
        ...
        if nblettrea!=0 and nblettreb!=0 : #Test variable(s) vide(s) pour message erreur
            for k in a :
                ...
                if x==32 : #Si c'est un espace, on lui donne 64 comme valeur
                    ...
                    x=x-96
##                elif x==10 :# Si c est un retour a la ligne, on lui donne 54 comme valeur
##                    x=65
                elif x==46 : #Si c'est un point on lui donne 63
                    x=63
                elif x>47 and x<58 : #Si c'est un chiffre on le met entre 53 et 62
...
def cryptage_doc () :
    ...
    b=code_cle.get()
    fichier.close
    result_a_ecrire=cryptage(lecture,b,1)
    result_a_ecrire=result_a_ecrire[1:-1]
...
def decryptage_doc () :
    ...
    b=decode_cle.get()
    fichier.close
    result_a_ecrire=decryptage(lecture,b,1)
    result_a_ecrire=result_a_ecrire[1:-1]
