...
def texte_aide (version) :
    ''' Renvoie le texte à afficher dans la fenetre aide, en fonction, de la
        ...
        Args:
            version (str): La version du programme

        Returns:
            str: Le texte à afficher dans la fenetre aide
        '''
...
#Creer les fonctions cyptage_mot / decryptage_mot /// elle retournent les valeurs finales des mots ou un int (0,1... en fonction de l'erreur)
def cryptage_mot (mot,cle) :
    """Fonction qui code un mot avec une clé

    Args:
        mot (str): mot à coder
        cle (str): clé de chiffrement

    Returns:
        str: mot chiffré par la clé
    """
...
def decryptage_mot (mot,cle) :
    """Fonction qui décode un mot avec une clé
...
def fonction_boutton_coder () :
    """Fonction appelée par le bouton "Crypter"
    """
...
def fonction_boutton_decoder () :
    """Fonction appelée par le bouton "décrypter"
    """
...
def fonction_boutton_coder_doc () :
    """Fonction appelée par le bouton "Crypter document"
    """
    mot= mot_a_coder_rentre.get()
    cle= code_cle.get()
...
def fonction_boutton_decoder_doc () :
    """Fonction appelée par le bouton "décrypter document"
    """
    mot= mot_a_decoder_rentre.get()
    cle= decode_cle.get()
    fichier = open("documents/"+mot+".txt",'r')
